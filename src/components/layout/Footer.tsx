...
export const Footer = () => (
  <footer className="bg-black text-white mt-auto">
    <div className="max-w-7xl mx-auto px-8 pt-12 pb-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
      <div>
      ...
      {INFO_CATEGORIES.map((category) => (
        <div key={category}>
          <h4 className="font-black text-xs tracking-widest text-gray-400 mb-4 uppercase">{category}</h4>
