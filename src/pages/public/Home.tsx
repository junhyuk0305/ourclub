  ...
  <section className="border-b border-black bg-gray-50 overflow-hidden py-24 md:py-32">
    <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
      <div>
        ...
        <FadeInText as="h2" className="text-4xl md:text-5xl font-black tracking-tight mb-4 leading-tight">검증된 동아리들의<br />생생한 스토리</FadeInText>
          ...
          <div className="flex p-4 gap-4">
            {filters.map(filter => (
              <button
                ...
                className={`whitespace-nowrap px-6 py-2.5 font-bold border border-black text-sm transition-colors ${
                  activeFilter === filter
