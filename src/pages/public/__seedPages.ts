/* TEMP dev-only — generated from 20260521000000_seed_enterprise_clubs_v2.sql. Remove before ship. */
export const seedPages: Record<string, any> = {
 "dev-hustler": {
  "config": {
    ...
    "slides": [
     {
      "id": "s1",
      "bgType": "gradient",
      "bgValue": "linear-gradient(135deg,#0f0f1a,#1e1b4b)",
      "overlayOpacity": 0,
      "align": "left",
      "h1": "Ship the web\nyou ==imagine==",
 ...
 "frame": {
  ...
  "blocks": [
   ...
   },
   {
    ...
    "bgColor": "#0a0a0a",
    "textColor": "#fafaf9",
    "accentColor": "rgba(250,250,249,0.35)"
   },
   {
    "id": "title1",
    "type": "text",
   ...
   },
   {
    ...
    "images": [
     {
      "id": "g1",
      "src": "https://images.unsplash.com/photo-1500051638674-ff996a0ec29e?auto=format&fit=crop&w=1200&q=80"
     },
     {
      "id": "g2",
     ...
     {
      "id": "g4",
      "src": "https://images.unsplash.com/photo-1493863641943-9b68992a8d07?auto=format&fit=crop&w=900&q=80"
     },
     {
      "id": "g5",
      "src": "https://images.unsplash.com/photo-1510127034890-ba27508e9f1c?auto=format&fit=crop&w=900&q=80"
     },
     {
      "id": "g6",
      "src": "https://images.unsplash.com/photo-1504198266287-1659872e6590?auto=format&fit=crop&w=900&q=80"
     }
    ]
   },
   {
    ...
    "items": [
     ...
     },
     {
      "id": "l3",
      "text": "학기 정기 전시",
      "sub": "외부 관객을 초대하는 오프라인 전시"
     },
     {
      "id": "l4",
      "text": "필름 · 디지털 자유",
      "sub": "라이카부터 미러리스까지 장비 무관"
     }
    ]
   },
   {
  ...
  "blocks": [
   ...
   },
   {
    ...
    "images": [
     ...
     {
      "id": "g6",
      "src": "https://images.unsplash.com/photo-1542744094-3a31f272c490?auto=format&fit=crop&w=900&q=85"
     }
    ]
   },
   {
   ...
   },
   {
    ...
    "items": [
     {
      "id": "l1",
      "text": "매주 목요일 저녁 브랜드 세션",
      "sub": "90분 · 실제 클라이언트 브리핑 기반"
     },
     {
      "id": "l2",
      "text": "기업 클라이언트 실전 프로젝트",
      "sub": "반기별 진행"
     },
     {
      "id": "l3",
   ...
   },
   {
    ...
    "items": [
     ...
     },
     {
      ...
      "name": "박준호",
      "role": "부회장 · 크리에이티브",
      "imgSrc": "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=600&q=80"
     },
     {
      "id": "m3",
      "name": "이소연",
